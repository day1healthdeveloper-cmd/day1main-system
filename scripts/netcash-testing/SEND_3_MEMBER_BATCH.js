...
async function send() {
  ...
  console.log(`Amount: R1.00 each (R3.00 total)\n`);
  ...
  lines.push(['T', 'SPUTNIK3', 'Test Account', '1', 'Test Account', '4', '632005', '0', '123456789', '', '100', 'test@example.com', 'SPUTNIK', 'SPUTNIK3', actionDate].join('\t'));
  lines.push(['F', '3', '300', '9999'].join('\t'));
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  ...
  console.log(`Total: R3.00 (3 members x R1.00)`);
}
