  ...
  return (
    <SidebarLayout>
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Financial Reporting System</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">
                The financial reporting system is currently under development.
              </p>
              <div className="max-w-md mx-auto text-left space-y-2">
                ...
                <p className="text-sm text-gray-600">✓ Custom financial reports</p>
              </div>
              <Button 
                variant="outline" 
                className="mt-6"
