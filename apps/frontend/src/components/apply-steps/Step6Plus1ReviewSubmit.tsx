/**
 * Step 6 of 6: Review, Terms & Submit (Plus1Confirm Only)
 * 
 * Final step for Plus1Rewards members - modified terms and conditions
 * - Application summary with edit buttons
 * - Modified Terms & Conditions for Plus1 (no payment info)
...
export default function Step6Plus1ReviewSubmit({ data, updateData, prevStep, goToStep }: Props) {
  ...
  const getBrochureUrl = () => {
    // Brochures are in public/cover plan brochures folder
      ...
      <div className="space-y-3">
        ...
        <div className="border border-gray-300 rounded-lg p-3">
          ...
          <div className="border border-gray-300 rounded p-2 max-h-32 overflow-y-auto bg-gray-50 text-xs mb-2">
            ...
            <p className="mb-1">
              <span><strong>4. Coverage:</strong> Begins after confirmation call and final approval from admin.</span>
            </p>
          </div>
